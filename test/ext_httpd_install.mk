...
$(call ,$(call ext_httpd_install,$(shell pwd)/tmp/,2.4.17))
$(call ,$(call ext_httpd_install,$(shell pwd)/TMP/,2.4.17))# Unused configuration
...
.PHONY: hash
hash:
	$(info $(call hash4,$(shell pwd)/tmp/2.4.17))
	@true
